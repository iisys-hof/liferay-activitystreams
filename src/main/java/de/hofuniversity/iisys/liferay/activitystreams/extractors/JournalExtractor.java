...
{
	public static final String JOURNAL_ARTICLE_CLASS =
			"com.liferay.journal.model.JournalArticle";
	public static final String JOURNAL_FOLDER_CLASS =
			...
			SocialActivityContainer container)
	{
		...
		if(JOURNAL_ARTICLE_CLASS.equals(className))
		{
			journalArticle(activity, container);
		}
		else if(JOURNAL_FOLDER_CLASS.equals(className))
		{
